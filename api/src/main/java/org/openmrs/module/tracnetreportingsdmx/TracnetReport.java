...
public class TracnetReport  {
	...
	public static ReportDefinition getTracnetReportDefinition(boolean forceUpdate) {
		...
		if (forceUpdate) {
			...
			Properties indicatorSpecification = ObjectUtil.loadPropertiesFromClasspath("org/openmrs/module/tracnetreportingsdmx/IndicatorSpecifications-10.properties");
